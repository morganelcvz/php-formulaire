...
class Favorites {
    ...
    public static function totalfollowers($user_id)
{
...
public static function totalfollowing($user_id)
{
    // AFFICHAGE DES FOLLOWINGS TOTAL // 
    // connexion à la base de données via PDO (PHP Data Objects) = création instance
    $pdo = new PDO('mysql:host=' . DB_HOST . ';dbname=' . DB_NAME . ';charset=utf8', DB_USER, DB_PASS);
    ...
    // requete SQL me permettant de compter tous les favoris d'un utilisateur 
